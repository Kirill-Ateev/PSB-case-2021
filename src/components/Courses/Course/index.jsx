...
const Course = ({ balance, setBalance }) => {
  ...
  return (
    <>
      ...
      <Typography variant="h4" className={classes.title}>Вводный курс по разработке платформы онбординга новых сотрудников</Typography>
        <div className={classes.sidebar}>
          ...
          <List component="nav">
            ...
            <ListItemButton onClick={() => setOpen({ ...open, q2: !open.q2 })}>
              <ListItemText
                primary={<b>2. Методология и стэк</b>}
              />
            ...
            <ListItemButton onClick={() => setOpen({ ...open, q3: !open.q3 })}>
              <ListItemText
                primary={<b>3. Цели и план работ</b>}
              />
